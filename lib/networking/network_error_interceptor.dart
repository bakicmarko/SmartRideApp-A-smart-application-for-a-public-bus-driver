...
class ErrorExtractorInterceptor extends Interceptor {
  ...
  /// bool _isUnexpectedHttpExConnnectionClosed(DioError err) {
  ///   return err.error is HttpException && err.message.contains('Connection closed before full header was received');
  /// }
}
